...
import SearchIcon from "@/assets/table-bar/search.svg?component";
...
export default defineComponent({
  ...
  async setup(props, context) {
    if (props?.columnsApi !== undefined) {
      ...
      fixedProps.columns = await fixApiColumns(props.columnsApi, props.columns);
      return componentSetUp(fixedProps, context);
    } else {
